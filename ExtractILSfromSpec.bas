Attribute VB_Name = "ExtractILSfromSpec"
Sub ExtractILSFromSpec()
    ...
    With flDialog
        ...
        If .Show = -1 Then
            If .SelectedItems.Count >= 1 Then
                ...
                objRegExp.Pattern = ".*library uses.*"
                ...
                For Each vntWord In .SelectedItems
                    ...
                    For Each tbRange In objWordDoc.Paragraphs
                        ...
                        For Each objMatch In objMatches
                            ...
                            Range("A" & CStr(lngLoop)).Value = vntWord
                            Range("B" & CStr(lngLoop)).Value = objMatch.Value
                            ' Change the counter.
                            lngLoop = lngLoop + 1
                        Next
                    Next
